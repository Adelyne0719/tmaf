...
const code = fs.readFileSync('e:/Programing/Divelopment/primal/global.lua', 'utf8');
const lines = code.split('\n');
const newLines = lines.slice(0, 4983);
fs.writeFileSync('e:/Programing/Divelopment/primal/global.lua', newLines.join('\n') + '\n' + tail);
